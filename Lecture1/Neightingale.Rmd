...
![Original Nightingale Grapic](Nightingale-graphic.jpg)

This graphic is remarkable both for the amount of information displayed and considering the state of analytics 160 year ago. In our era we have many more tools at our disposal that Florance Nightingale could have imagined. Let's have a look at what we can do with these tools.
...
The monthly values of a number of variables measuring the casualty rates of the British army are included in these data. A number of inteteresting aspects of the data set are apparent from this summary. The distributions of deaths from disease and wounds are highly skewed. This can be seen by the large gap between te means and the medians of these distributions. 
...
Let's have a look at the distribution of casualties in these data.
